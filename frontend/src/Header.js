...
export default function Header() {
    return (
        ...
        <Container>
        <Navbar.Brand className='navtitle' href="#home">PurpleShades.com</Navbar.Brand>
        <Nav className="me-auto navlinks">
          <Nav.Link href="#home">Home</Nav.Link>
          <Nav.Link href="#features">Men</Nav.Link>
          <Nav.Link href="#pricing">Women</Nav.Link>
          <Nav.Link href="#pricing">Children</Nav.Link>
...
<a  href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart cart" viewBox="0 0 16 16">
